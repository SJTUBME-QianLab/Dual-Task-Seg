...
from data.dataloader import Generalize_Tumor_Skeleton_in_Tumor_MSD_Renji
...
def get_args():
    ...
    parser.add_argument(
        ...
        default=6000000,
        metavar="N",
        help="number of size (default: 6000000)",
    )
    parser.add_argument(
        "--lr",
        type=float,
...
def generalize_train_pool_u_conresnet(args):
    ...
    model = U_CorResNet_Fix_Contrastive_Proj_DT_CCLS_RC(
    ...
    dset_train = Generalize_Tumor_Skeleton_in_Tumor_MSD_Renji(
